...
func (*RegisterNodeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_local_56fb2fc597b03eba, []int{0}
}
...
type NodeClient interface {
	// CreateFileView returns a view on the given file identified by the given URI.
	CreateFileView(ctx context.Context, in *fs.CreateFileViewRequest, opts ...grpc.CallOption) (*fs.CreateFileViewResponse, error)
}
...
func (c *nodeClient) CreateFileView(ctx context.Context, in *fs.CreateFileViewRequest, opts ...grpc.CallOption) (*fs.CreateFileViewResponse, error) {
...
type NodeServer interface {
	// CreateFileView returns a view on the given file identified by the given URI.
	CreateFileView(context.Context, *fs.CreateFileViewRequest) (*fs.CreateFileViewResponse, error)
}
...
func _Node_CreateFileView_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(fs.CreateFileViewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServer).CreateFileView(ctx, req.(*fs.CreateFileViewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func init() { proto.RegisterFile("local.proto", fileDescriptor_local_56fb2fc597b03eba) }

var fileDescriptor_local_56fb2fc597b03eba = []byte{
	// 326 bytes of a gzipped FileDescriptorProto
	,
}
