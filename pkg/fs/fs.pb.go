...
type CreateVolumeForWriteRequest struct {
	...
	EstimatedCapacity int64 `protobuf:"varint,1,opt,name=EstimatedCapacity,json=estimatedCapacity,proto3" json:"EstimatedCapacity,omitempty"`
	...
	Owner *v1.OwnerReference `protobuf:"bytes,3,opt,name=Owner,json=owner" json:"Owner,omitempty"`
...
func (*CreateVolumeForWriteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fs_c774640a6a9968c1, []int{0}
}
...
type CreateVolumeForWriteResponse struct {
	...
	VolumeName string `protobuf:"bytes,1,opt,name=VolumeName,json=volumeName,proto3" json:"VolumeName,omitempty"`
	// Name of the PersistentVolumeClaim to mount
	VolumeClaimName string `protobuf:"bytes,2,opt,name=VolumeClaimName,json=volumeClaimName,proto3" json:"VolumeClaimName,omitempty"`
	// Path of Node that contains the Volume (as HostPath volume)
	// Either VolumeName or VolumePath must be set, not both.
	VolumePath string `protobuf:"bytes,3,opt,name=VolumePath,json=volumePath,proto3" json:"VolumePath,omitempty"`
	// SubPath to add to VolumeName, VolumeClaimName or VolumePath.
	SubPath string `protobuf:"bytes,4,opt,name=SubPath,json=subPath,proto3" json:"SubPath,omitempty"`
	// Name of the Node on which the volume is created
	NodeName string `protobuf:"bytes,5,opt,name=NodeName,json=nodeName,proto3" json:"NodeName,omitempty"`
	// If set, the caller must delete the PersistentVolume or PersistentVolumeClaim after use
	DeleteAfterUse       bool     `protobuf:"varint,6,opt,name=DeleteAfterUse,json=deleteAfterUse,proto3" json:"DeleteAfterUse,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*CreateVolumeForWriteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fs_c774640a6a9968c1, []int{1}
}
...
type CreateFileURIRequest struct {
	...
	VolumeName string `protobuf:"bytes,2,opt,name=VolumeName,json=volumeName,proto3" json:"VolumeName,omitempty"`
	// Name of the PersistentVolumeClaim that contains the file/dir
	VolumeClaimName string `protobuf:"bytes,3,opt,name=VolumeClaimName,json=volumeClaimName,proto3" json:"VolumeClaimName,omitempty"`
	// Path of Node that contains the Volume (as HostPath volume)
	// One of VolumeName, VolumeClaimName or VolumePath must be set, not multiple.
	VolumePath string `protobuf:"bytes,4,opt,name=VolumePath,json=volumePath,proto3" json:"VolumePath,omitempty"`
	// SubPath to add to VolumeName or VolumePath.
	SubPath string `protobuf:"bytes,5,opt,name=SubPath,json=subPath,proto3" json:"SubPath,omitempty"`
	// Name of the Node on which the volume resides
	NodeName string `protobuf:"bytes,6,opt,name=NodeName,json=nodeName,proto3" json:"NodeName,omitempty"`
...
func (*CreateFileURIRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fs_c774640a6a9968c1, []int{2}
}
...
func (*CreateFileURIResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fs_c774640a6a9968c1, []int{3}
}
...
type CreateVolumeForReadRequest struct {
	...
	URI string `protobuf:"bytes,1,opt,name=URI,json=uRI,proto3" json:"URI,omitempty"`
	// If set and allow, this the PersistentVolume will be owned by this owner reference.
	Owner *v1.OwnerReference `protobuf:"bytes,2,opt,name=Owner,json=owner" json:"Owner,omitempty"`
	// Namespace of the resources created for this request.
...
func (*CreateVolumeForReadRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fs_c774640a6a9968c1, []int{4}
}
...
type CreateVolumeForReadResponse struct {
	...
	LocalPath string `protobuf:"bytes,6,opt,name=LocalPath,json=localPath,proto3" json:"LocalPath,omitempty"`
	// IsDir indicates if the URI is for a file (false) or a directory (true)
	IsDir bool `protobuf:"varint,7,opt,name=IsDir,json=isDir,proto3" json:"IsDir,omitempty"`
	// If set, the caller must delete the PersistentVolume after use
	DeleteAfterUse       bool     `protobuf:"varint,8,opt,name=DeleteAfterUse,json=deleteAfterUse,proto3" json:"DeleteAfterUse,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (*CreateVolumeForReadResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fs_c774640a6a9968c1, []int{5}
}
...
func (*CreateFileViewRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fs_c774640a6a9968c1, []int{6}
}
...
func (*CreateFileViewResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fs_c774640a6a9968c1, []int{7}
}
...
func init() { proto.RegisterFile("fs.proto", fileDescriptor_fs_c774640a6a9968c1) }

var fileDescriptor_fs_c774640a6a9968c1 = []byte{
	// 683 bytes of a gzipped FileDescriptorProto
	,
}
